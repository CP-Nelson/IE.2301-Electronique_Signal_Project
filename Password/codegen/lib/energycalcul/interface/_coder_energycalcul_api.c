 ...
 * File: _coder_energycalcul_api.c
 *
...
void energycalcul_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  ...
  timeLeft = energycalcul(timeLeft, timeRight, *amp);
...
void energycalcul_atexit(void)
{
  ...
  energycalcul_xil_terminate();
  energycalcul_xil_shutdown();
...
/*
 * File trailer for _coder_energycalcul_api.c
 *
 * [EOF]
 */
